# -*- coding: utf-8 -*-
"""
Created on Fri Nov  8 11:02:58 2024
...
navajo_min_release = 250*1.98211 # cfs to AF
navajo_max_release = 5000*1.98211 # cfs to AF
...
class ReservoirEnv(Env):
    def __init__(self, data, scaler):
        ...
        # Extract and store the original unscaled storage, release, evaporation, and inflow values
        ...
        self.evaporation_history = unscaled_data[:, 1].tolist()     # Unscaled evaporation column
        self.inflow_history = unscaled_data[:, 2].tolist()          # Unscaled inflow column
...
# Plot storage, release, inflow, evaporation, and rewards after training
plt.figure(figsize=(14, 12))

# Plot storage comparison with inflow and evaporation
plt.subplot(4, 1, 1)
...
plt.xlabel('Days')
plt.ylabel('Storage/Inflow/Evaporation (af)')
plt.title('Predicted vs Actual Storage, Inflow, and Evaporation over Training Period')
