...
min_release_af = normalize(49*1.98211, means[3], stds[3])
max_release_af = normalize(3000*1.98211, means[3], stds[3])
...
class ReservoirEnv(Env):
    ...
    def step(self, action):
        ...
        self.current_storage = (self.current_storage*stds[0]+means[0])+((inflow_af*stds[2]+means[2]) - (evaporation_af*stds[1]+means[1]) - (release_af_value*stds[3]+means[3]))
...
for i in range(len(test_data)):
    ...
    current_storage = (current_storage*stds[0]+means[0])+((inflow_af*stds[2]+means[2]) - (evaporation_af*stds[1]+means[1]) - (predicted_release_af*stds[3]+means[3]))
...
# Testing for initial storage 50 percent above the storage limit
...
plt.legend()
plt.grid()
plt.savefig("50_percent_above_test_predicted_vs_actual_storage.png")
plt.show()
...
plt.legend()
plt.grid()
plt.savefig("50_percent_above_test_predicted_vs_actual_release.png")
plt.show()
...
plt.legend()
plt.grid()
plt.savefig("50_percent_above_test_predicted_vs_actual_storage_rescaled.png")
plt.show()
...
plt.legend()
plt.grid()
plt.savefig("50_percent_above_test_predicted_vs_actual_release_rescaled.png")
plt.show()

# Testing for initial storage 50 percent below the storage limit
...
plt.legend()
plt.grid()
plt.savefig("50_percent_below_test_predicted_vs_actual_storage.png")
plt.show()
...
plt.legend()
plt.grid()
plt.savefig("50_percent_below_test_predicted_vs_actual_release.png")
plt.show()
...
plt.legend()
plt.grid()
plt.savefig("50_percent_below_test_predicted_vs_actual_storage_rescaled.png")
plt.show()
...
plt.legend()
plt.grid()
plt.savefig("50_percent_below_test_predicted_vs_actual_release_rescaled.png")
plt.show()