...
for _ in range(num_episodes):
    ...
    for _ in range(episode_length):
        ...
        predicted_release.append(test_env.release_history[-1] if test_env.release_history else np.nan)  # Last release action taken
...
plt.legend()
plt.grid()
plt.savefig("Predicted_vs_Actual_Release.png")
plt.show()
